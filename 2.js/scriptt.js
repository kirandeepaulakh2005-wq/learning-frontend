...
//setTimeout:ekk bar chalega ,esme hum time limit dete heh jiske bhadh jo bhi  hum function chalana chate heh woh chal jata heh.
setTimeout(function(){
   console.log("hello"); 
},5000);

//setInterval:yeh function ko repeat krta heh limited time ke bhadgh jo hum khudh se dete heh.
...
//clearInterval:esme hum setInterval ko hata dete heh jisse humara function nhi chalta.
let mm=setInterval(function(){
   console.log("hello"); 
},5000);
clearInterval(mm);

//making counter using Interval:
let count=10;
